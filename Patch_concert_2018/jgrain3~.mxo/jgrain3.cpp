...
class mydsp : public dsp {
	  ...
	  public:
		...
		void fill (int count, double output[]) {
			for (int i=0; i<count; i++) {
				iRec11[0] = (iRec11[1] + 1);
				output[i] = faustpower<2>(sin((3.2724923474893676e-05 * double((iRec11[0] + -1)))));
				// post processing
				iRec11[1] = iRec11[0];
			}
		}
  ...
  public:
	virtual void metadata(Meta* m) { 
		...
		m->declare("library_path", "jgrain3");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("Jgrain 7");
		ui_interface->openHorizontalBox("Grain");
		ui_interface->openVerticalBox("Grain_Delay");
		ui_interface->addHorizontalSlider("del 0", &fslider6, 0.0, 0.0, 5e+03, 0.1);
		ui_interface->addHorizontalSlider("del 1", &fslider10, 0.0, 0.0, 5e+03, 0.1);
		ui_interface->addHorizontalSlider("del 2", &fslider14, 0.0, 0.0, 5e+03, 0.1);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Grain_FeedBackext");
		ui_interface->addHorizontalSlider("fdx 0", &fslider2, 1.0, 0.0, 1.0, 0.01);
		ui_interface->addHorizontalSlider("fdx 1", &fslider3, 1.0, 0.0, 1.0, 0.01);
		ui_interface->addHorizontalSlider("fdx 2", &fslider4, 1.0, 0.0, 1.0, 0.01);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Grain_Rarefaction");
		ui_interface->addHorizontalSlider("rar 0", &fslider1, 0.5, 0.0, 1.0, 0.0001);
		ui_interface->addHorizontalSlider("rar 1", &fslider8, 0.5, 0.0, 1.0, 0.0001);
		ui_interface->addHorizontalSlider("rar 2", &fslider12, 0.5, 0.0, 1.0, 0.0001);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Grain_Size");
		ui_interface->addHorizontalSlider("size 0", &fslider0, 5e+01, 0.0, 1e+03, 0.01);
		ui_interface->addHorizontalSlider("size 1", &fslider7, 5e+01, 0.0, 1e+03, 0.01);
		ui_interface->addHorizontalSlider("size 2", &fslider11, 5e+01, 0.0, 1e+03, 0.01);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Input");
		ui_interface->declare(&fslider5, "5", "");
		ui_interface->addHorizontalSlider("inp 0", &fslider5, 1.0, 0.0, 1.0, 0.01);
		ui_interface->declare(&fslider9, "5", "");
		ui_interface->addHorizontalSlider("inp 1", &fslider9, 1.0, 0.0, 1.0, 0.01);
		ui_interface->declare(&fslider13, "5", "");
		ui_interface->addHorizontalSlider("inp 2", &fslider13, 1.0, 0.0, 1.0, 0.01);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("Output");
		ui_interface->declare(&fslider15, "6", "");
		ui_interface->addHorizontalSlider("out 0", &fslider15, 1.0, 0.0, 1.0, 0.01);
		ui_interface->declare(&fslider16, "6", "");
		ui_interface->addHorizontalSlider("out 1", &fslider16, 1.0, 0.0, 1.0, 0.01);
		ui_interface->declare(&fslider17, "6", "");
		ui_interface->addHorizontalSlider("out 2", &fslider17, 1.0, 0.0, 1.0, 0.01);
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute (int count, FAUSTFLOAT** input, FAUSTFLOAT** output) {
		...
		double 	fSlow8 = (0.0010000000000000009 * double(fslider5));
		double 	fSlow9 = (fConst2 * double(fslider6));
		double 	fSlow10 = (fConst1 / double(fslider7));
		double 	fSlow11 = double(fslider8);
		double 	fSlow12 = double(fcheckbox3);
		double 	fSlow13 = double(fcheckbox4);
		double 	fSlow14 = double(fcheckbox5);
		double 	fSlow15 = (0.0010000000000000009 * double(fslider9));
		double 	fSlow16 = (fConst2 * double(fslider10));
		double 	fSlow17 = (fConst1 / double(fslider11));
		double 	fSlow18 = double(fslider12);
		double 	fSlow19 = double(fcheckbox6);
		double 	fSlow20 = double(fcheckbox7);
		double 	fSlow21 = double(fcheckbox8);
		double 	fSlow22 = (0.0010000000000000009 * double(fslider13));
		double 	fSlow23 = (fConst2 * double(fslider14));
		double 	fSlow24 = (0.0010000000000000009 * double(fslider15));
		double 	fSlow25 = (0.0010000000000000009 * double(fslider16));
		double 	fSlow26 = (0.0010000000000000009 * double(fslider17));
		...
		for (int i=0; i<count; i++) {
			fRec4[0] = (fSlow0 + (fRec4[1] - floor((fSlow0 + fRec4[1]))));
			double fTemp0 = (fRec4[0] - floor(fRec4[0]));
			fVec0[0] = fTemp0;
			int iTemp1 = ((fVec0[0] > 0.001) * (fVec0[1] <= 0.001));
			int iTemp2 = (1 - iTemp1);
			iRec5[0] = ((1103515245 * iRec5[1]) + 12345);
			double fTemp3 = ((4.656612875245797e-10 * iRec5[0]) + 1);
			double fTemp4 = (0.5 * fTemp3);
			iRec3[0] = ((iTemp2 * iRec3[1]) + (iTemp1 * (fTemp4 < fSlow1)));
			fRec6[0] = (fSlow3 + (0.999 * fRec6[1]));
			double fTemp5 = (fRec6[0] * fRec0[1]);
			fRec7[0] = (fSlow5 + (0.999 * fRec7[1]));
			double fTemp6 = (fRec7[0] * fRec1[1]);
			fRec8[0] = (fSlow7 + (0.999 * fRec8[1]));
			double fTemp7 = (fRec8[0] * fRec2[1]);
			fRec9[0] = (fSlow8 + (0.999 * fRec9[1]));
			double fTemp8 = ((((fSlow2 * fTemp5) + (fSlow4 * fTemp6)) + (fSlow6 * fTemp7)) + (fRec9[0] * (double)input0[i]));
			fVec1[IOTA&262143] = fTemp8;
			fRec10[0] = ((fRec10[1] * iTemp2) + (fSlow9 * (iTemp1 * fTemp3)));
			int iTemp9 = int(fRec10[0]);
			double fTemp10 = floor(fRec10[0]);
			fRec0[0] = ((iRec3[0] * ((fVec1[(IOTA-int((iTemp9 & 262143)))&262143] * (fTemp10 + (1 - fRec10[0]))) + ((fRec10[0] - fTemp10) * fVec1[(IOTA-int((int((iTemp9 + 1)) & 262143)))&262143]))) * ftbl0[int((192000 * fRec4[0]))]);
			fRec13[0] = (fSlow10 + (fRec13[1] - floor((fSlow10 + fRec13[1]))));
			double fTemp11 = (fRec13[0] - floor(fRec13[0]));
			fVec2[0] = fTemp11;
			int iTemp12 = (fVec2[0] > 0.001);
			int iTemp13 = (fVec2[1] <= 0.001);
			int iTemp14 = (iTemp12 * iTemp13);
			int iTemp15 = (1 - iTemp14);
			iRec12[0] = ((iTemp15 * iRec12[1]) + (iTemp14 * (fTemp4 < fSlow11)));
			fRec14[0] = (fSlow15 + (0.999 * fRec14[1]));
			double fTemp16 = ((((fSlow12 * fTemp5) + (fSlow13 * fTemp6)) + (fSlow14 * fTemp7)) + (fRec14[0] * (double)input1[i]));
			fVec3[IOTA&262143] = fTemp16;
			fRec15[0] = ((fRec15[1] * iTemp15) + (fSlow16 * ((fTemp3 * iTemp12) * iTemp13)));
			int iTemp17 = int(fRec15[0]);
			double fTemp18 = floor(fRec15[0]);
			fRec1[0] = ((iRec12[0] * ((fVec3[(IOTA-int((iTemp17 & 262143)))&262143] * (fTemp18 + (1 - fRec15[0]))) + ((fRec15[0] - fTemp18) * fVec3[(IOTA-int((int((iTemp17 + 1)) & 262143)))&262143]))) * ftbl0[int((192000 * fRec13[0]))]);
			fRec17[0] = (fSlow17 + (fRec17[1] - floor((fSlow17 + fRec17[1]))));
			double fTemp19 = (fRec17[0] - floor(fRec17[0]));
			fVec4[0] = fTemp19;
			int iTemp20 = (fVec4[0] > 0.001);
			int iTemp21 = (fVec4[1] <= 0.001);
			int iTemp22 = (iTemp20 * iTemp21);
			int iTemp23 = (1 - iTemp22);
			iRec16[0] = ((iTemp23 * iRec16[1]) + (iTemp22 * (fTemp4 < fSlow18)));
			fRec18[0] = (fSlow22 + (0.999 * fRec18[1]));
			double fTemp24 = ((((fSlow19 * fTemp5) + (fSlow20 * fTemp6)) + (fSlow21 * fTemp7)) + (fRec18[0] * (double)input2[i]));
			fVec5[IOTA&262143] = fTemp24;
			fRec19[0] = ((fRec19[1] * iTemp23) + (fSlow23 * ((fTemp3 * iTemp20) * iTemp21)));
			int iTemp25 = int(fRec19[0]);
			double fTemp26 = floor(fRec19[0]);
			fRec2[0] = ((iRec16[0] * ((fVec5[(IOTA-int((iTemp25 & 262143)))&262143] * (fTemp26 + (1 - fRec19[0]))) + ((fRec19[0] - fTemp26) * fVec5[(IOTA-int((int((iTemp25 + 1)) & 262143)))&262143]))) * ftbl0[int((192000 * fRec17[0]))]);
			fRec20[0] = (fSlow24 + (0.999 * fRec20[1]));
			output0[i] = (FAUSTFLOAT)(fRec0[0] * fRec20[0]);
			fRec21[0] = (fSlow25 + (0.999 * fRec21[1]));
			output1[i] = (FAUSTFLOAT)(fRec1[0] * fRec21[0]);
			fRec22[0] = (fSlow26 + (0.999 * fRec22[1]));
			output2[i] = (FAUSTFLOAT)(fRec2[0] * fRec22[0]);
			// post processing
			fRec22[1] = fRec22[0];
			fRec21[1] = fRec21[0];
			fRec20[1] = fRec20[0];
